export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch(`${url}/functions/v1/ocr-prescripcion`, {
      method: 'POST', headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${key}` }, body: JSON.stringify(req.body)
    });
